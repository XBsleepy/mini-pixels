...
int main()
{
    ...
    while (true)
    {
        ...
        if (command == "LOAD")
        {
            ...
            desc.add_options()("help,h", "show this help message and exit")("origin,o", bpo::value<std::string>()->required(), "specify the path of original data files")("target,t", bpo::value<std::string>()->required(), "specify the path of target data files")("schema,s", bpo::value<std::string>()->required(), "specify the schema of pixels")("row_num,n", bpo::value<int>()->required(), "specify the max number of rows to write in a file")("row_regex,r", bpo::value<std::string>()->required(), "specify the split regex of each row in a file")("encoding_level,e", bpo::value<int>()->default_value(2), "specify the encoding level for data loading")("nulls_padding,p", bpo::value<bool>()->default_value(false), "specify whether nulls padding is enabled");
